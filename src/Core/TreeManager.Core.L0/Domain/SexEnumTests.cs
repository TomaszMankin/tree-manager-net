...
public class SexEnumTests
{
    ...
    {
        Assert.Equal("Nieznana", Serialize(Sex.Unknown));
    }
    ...
    {
        Assert.Equal("Mężczyzna", Serialize(Sex.Male));
    }
    ...
    {
        Assert.Equal("Kobieta", Serialize(Sex.Female));
    }
    ...
    {
        Assert.Equal(Sex.Male, Deserialize("Mężczyzna"));
    }
    ...
    {
        // py-tree-manager fixtures use unaccented form — must deserialize cleanly
        Assert.Equal(Sex.Male, Deserialize("Mezczyzna"));
    }
    ...
    {
        Assert.Equal(Sex.Female, Deserialize("Kobieta"));
    }
    ...
    {
        Assert.Equal(Sex.Unknown, Deserialize("Nieznana"));
    }
